"use strict";
{
    ...
    xx = {};
    xx = () => { };
    let xage = xx; //trzeba uważać ponieważ zmienną any mozemy potem przypisac do innej zmiennej ktora juz nie jest any, ale TS przyjmuje ze xx moze byc tyn numerem (mimo ze jest any)
